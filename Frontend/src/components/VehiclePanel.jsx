...
const VehiclePanel = (props) =>{
    return (
        <div>
              <h5 className='p-1 text-center w-[93%] absolute top-5' onClick={() => {
            ...
            <div onClick={()=>{
                ...
                <h2 className='text-lg font-semibold'><span className='font-bold'>₹</span>{props.fare.car}</h2>
            </div>
            <div onClick={()=>{
                props.setConfirmRidePanel(true)
                ...
                <h2 className='text-lg font-semibold'><span className='font-bold'>₹</span>{props.fare.moto}</h2>
            </div>
            <div onClick={()=>{
                props.setConfirmRidePanel(true)
                ...
                <h2 className='text-lg font-semibold'><span className='font-bold'>₹</span>{props.fare.auto}</h2>
            </div>   
        </div>
    )
}
